...
class Especialidad_Controller {
    ...
    getAll = async (req, res) => {
        await EspecialidadModel.findAll({}).then((data) => {
    ...
    add = async(req, res) => {
        ...
        await EspecialidadModel.create(datos).then((value) => {
    ...
    update = async(req, res) => {
        ...
        await EspecialidadModel.update(datos, {
            where: {
                id: datos.id
            }
        }).then((data) => {
...
module.exports = new Especialidad_Controller();