const CovidModel = require('../models/Caso_Covid_Model');

// --------- Controlador para Caso Covid ---------
// Recibe las peticiones y regresa una respuesta en formato json

class Caso_Covid_Controller {

    // Consulta select de todos los valores de la tabla
    getAll = async (req, res) => {
        await CovidModel.findAll({}).then((data) => {
    ...
    add = async(req, res) => {
        ...
        await CovidModel.create(datos).then((value) => {
...
module.exports = new Caso_Covid_Controller();