const Alergia_Model = require('../models/Alergia_Model');

// --------- Controlador para Alergias ---------
// Recibe las peticiones y regresa una respuesta en formato json

class Alergia_Controller {

    // Consulta select de todos los valores de la tabla
    getAll = async (req, res) => {
        await Alergia_Model.findAll({}).then((data) => {
...
user
    ...
    add = async(req, res) => {
        ...
        await Alergia_Model.create(datos).then((value) => {
    ...
    update = async(req, res) => {
        ...
        await Alergia_Model.update(datos, {
            where: {
                id: datos.id
            }
        }).then((data) => {
...
module.exports = new Alergia_Controller();